...
/**
 * Validate Ingest File Endpoint
 *
 * Validate a staged file against MinerU size/page limits (no enqueue).
 */
export const validateIngestFileEndpointIngestValidateFilePost = <ThrowOnError extends boolean = false>(options: Options<ValidateIngestFileEndpointIngestValidateFilePostData, ThrowOnError>): RequestResult<ValidateIngestFileEndpointIngestValidateFilePostResponses, ValidateIngestFileEndpointIngestValidateFilePostErrors, ThrowOnError> => (options.client ?? client).post<ValidateIngestFileEndpointIngestValidateFilePostResponses, ValidateIngestFileEndpointIngestValidateFilePostErrors, ThrowOnError>({
...
/**
 * Validate Ingest Url Endpoint
 *
 * Validate a URL: format, SSRF, reachability, and kind-aware PDF limits.
 */
export const validateIngestUrlEndpointIngestValidateUrlPost = <ThrowOnError extends boolean = false>(options: Options<ValidateIngestUrlEndpointIngestValidateUrlPostData, ThrowOnError>): RequestResult<ValidateIngestUrlEndpointIngestValidateUrlPostResponses, ValidateIngestUrlEndpointIngestValidateUrlPostErrors, ThrowOnError> => (options.client ?? client).post<ValidateIngestUrlEndpointIngestValidateUrlPostResponses, ValidateIngestUrlEndpointIngestValidateUrlPostErrors, ThrowOnError>({
