...
/**
 * DocumentDeleteModal — secondary confirmation modal for document deletion.
 * Reuses the PurgeConfirmModal visual style (danger red tone).
 */
export function DocumentDeleteModal({
  ...
  const t = useTranslations("kb.detail.docDeleteModal");
